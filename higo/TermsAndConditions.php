    ...
    <header class="page-wrapper">
            <div class="nav-wrapper">
                <div class="grad-bar"></div>
                    <nav class="navbar">
                        <a href="index.php"><img src="que/cambiado.svg" alt="Company Logo" class="lo"></a>
            ...
            <div class="columna1">
                <div class="cont">
                    <div>
                        ...
                        <p>
                        ¡Bienvenido a nuestra plataforma ACATDEMY! Te invitamos a leer detenidamente los siguientes términos y condiciones antes de registrarte y utilizar nuestros servicios. Al utilizar nuestra plataforma, aceptas cumplir con estos términos y condiciones. Si no estás de acuerdo con alguno de ellos, te pedimos que no utilices nuestros servicios.

                        </p><br><br>

                        <p class="negrita"><b id="esperar1">1. Registro y Privacidad</b></p><br>
                        <p>
                            <span id="puntode">Para acceder a nuestros cursos, debes registrarte en la plataforma proporcionando información personal. 
                                La protección de tus datos personales es de suma importancia para nosotros, y garantizamos su seguridad y privacidad de acuerdo con las leyes aplicables. Para obtener más información, consulta nuestra Política de Privacidad.</span>
                            
                            <br><br>
                            <span>Al registrarte, eres responsable de mantener la confidencialidad de tu nombre de usuario y contraseña, y aceptas que eres el único responsable de cualquier actividad realizada en tu cuenta.</span>
                            
                            
                        </p><br><br>

                        <p class="negrita"><b id="esperar2">2. Inscripción y Pagos</b></p><br>
                        <p>
                            <span>Puedes inscribirte en los cursos disponibles en nuestra plataforma directamente a través de la misma. Aceptamos pagos mediante transferencia bancaria, depósito o PayPal. Los detalles de pago se proporcionarán durante el proceso de inscripción en un curso.</span>
                            
                            <br><br>
                            <span>Los precios de los cursos se muestran en la plataforma y pueden estar sujetos a cambios. Te comprometes a pagar el monto total correspondiente a tu inscripción en un curso antes de acceder al contenido.</span>
                            
                            
                        </p><br><br>

                        <p class="negrita"><b id="esperar3">3. Uso de la Plataforma y Contenido</b></p><br>
                        <p>
                            <span>Nuestra plataforma está diseñada con Moodle para el aprendizaje en línea. Al utilizar nuestros cursos y materiales, aceptas no copiar, distribuir, modificar o utilizar el contenido de manera inapropiada.</span>
                            
                            <br><br>
                            <span>Te comprometes a no utilizar la plataforma con fines ilegales o inmorales, incluyendo el acoso, la difamación, la violación de derechos de autor y cualquier otra actividad prohibida por la ley.</span>
